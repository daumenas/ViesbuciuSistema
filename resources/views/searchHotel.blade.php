                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>{{$row->extraInfo}} </td>
                                <td></td>
                                <td><a href="{!! route('saveReview', ['rating'=>'2', 'hotelName'=>$row->name, 'city'=>$row->city]) !!}"><img src="images/1-2.png" alt="" border=3 height=25 width=25></a></td>
                                ...
                                @if(Auth::user()->role == 2 || Auth::user()->role == 1) <td><a href="{!! route('editHotel', ['id'=>$row->id]) !!}">Edit</a></td>@endif
